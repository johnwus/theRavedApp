...
@Entity
@Table(name = "faculties", uniqueConstraints = @UniqueConstraint(columnNames = {"university_id", "code"}))
public class Faculty {
  ...
  // Convenience method to get university ID
  public Long getUniversityId() { return university != null ? university.getId() : null; }
