...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentResponse processPayment(ProcessPaymentRequest request) {
        ...
        try {
            ...
            savedPayment.setStatus(result.isSuccess() ? "SUCCESS" : "FAILED");
    ...
    public PaymentResponse refundPayment(RefundPaymentRequest request) {
        ...
        try {
            ...
            savedRefund.setStatus(result.isSuccess() ? "COMPLETED" : "FAILED");
    ...
    public List<PaymentResponse> getPaymentsByStatus(String status) {
        ...
        Page<Payment> payments = paymentRepository.findByStatusOrderByCreatedAtDesc(status, Pageable.unpaged());
    ...
    public void retryFailedPayments() {
        ...
        for (Payment payment : failedPayments) {
            try {
                ...
                retryRequest.setPaymentMethod(
                        ProcessPaymentRequest.PaymentMethod.valueOf(payment.getPaymentMethod()));
    ...
    private RefundResult processRefundByMethod(Payment originalPayment, BigDecimal amount, String reason)
            throws Exception {
    ...
    private RefundResult processStripeRefund(Payment originalPayment, BigDecimal amount, String reason)
