...
export const ThemeToggle: React.FC<ThemeToggleProps> = ({ size = "medium", showLabels = true }) => {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        ...
        activeOpacity={0.7}
      >
        <Text style={getTextStyle("light")}>{showLabels ? "Light" : "☀️"}</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.7}
      >
        <Text style={getTextStyle(undefined)}>{showLabels ? "System" : "⚙️"}</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.7}
      >
        <Text style={getTextStyle("dark")}>{showLabels ? "Dark" : "🌙"}</Text>
      </TouchableOpacity>
    </View>
  )
}
