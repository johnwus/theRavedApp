    ...
    <ScrollView style={globalStyles.screen(theme)}>
      ...
      <View style={[cardStyles.container(theme), { margin: theme.spacing.md }]}>
        ...
        <Text style={globalStyles.textSecondary(theme)}>
          All style systems working together
        </Text>
      </View>
      ...
      <View style={[cardStyles.container(theme), { margin: theme.spacing.md }]}>
        ...
        <View style={componentUtils.flexColumn}>
          <TouchableOpacity style={[buttonStyles.button(theme), buttonStyles.primary(theme), buttonStyles.button_medium]}>
          ...
          <TouchableOpacity style={[buttonStyles.button(theme), buttonStyles.secondary(theme), buttonStyles.button_medium]}>
            <Text style={[buttonStyles.buttonText(theme), { color: theme.colors.white }]}>
              Secondary Button
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={[buttonStyles.button(theme), buttonStyles.outline(theme), buttonStyles.button_medium]}>
      ...
      <View style={[cardStyles.container(theme), { margin: theme.spacing.md }]}>
        ...
        <View style={componentUtils.flexColumn}>
          <View style={[componentUtils.flexRow, { alignItems: 'center' }]}>
            <View style={[{ backgroundColor: theme.colors.primary, width: 20, height: 20, borderRadius: 10 }]} />
            <View style={componentUtils.margin.sm} />
          ...
          <View style={[componentUtils.borders.rounded, { padding: theme.spacing.sm, borderWidth: 1, borderColor: theme.colors.border }]}>
      ...
      <View style={[cardStyles.container(theme), { margin: theme.spacing.md }]}>
        ...
        <Text style={globalStyles.textSecondary(theme)}>
          Colors: {Object.keys(theme.colors).length} | Spacing: {Object.keys(theme.spacing).length} | Shadows: {Object.keys(theme.shadows).length}
        </Text>
      </View>
    </ScrollView>
  );
