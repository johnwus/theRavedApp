...
export const API_ENDPOINTS = {
  ...
  POSTS: {
    FEED: "/posts/feed",
    FACULTY_FEED: (facultyId: string) => `/posts/faculty/${facultyId}`,
  ...
  FACULTIES: {
    ...
    MEMBERS: (facultyId: string) => `/faculties/${facultyId}/members`,
    EVENTS: (facultyId: string) => `/faculties/${facultyId}/events`,
  },
