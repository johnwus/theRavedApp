...
export const toast = {
  ...
  success: (title: string, message?: string, theme?: any) =>
    toastInstance.success(title, message, theme),
  error: (title: string, message?: string, theme?: any) =>
    toastInstance.error(title, message, theme),
  warning: (title: string, message?: string, theme?: any) =>
    toastInstance.warning(title, message, theme),
  info: (title: string, message?: string, theme?: any) => toastInstance.info(title, message, theme),

  // Financial transaction toasts
  paymentSuccess: (amount: string, recipient?: string, theme?: any) =>
    toastInstance.paymentSuccess(amount, recipient),
  ...
  itemRemovedFromCart: (itemName: string, theme?: any) =>
    toastInstance.itemRemovedFromCart(itemName),
