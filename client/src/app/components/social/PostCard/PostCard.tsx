  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.surface }]}>
      ...
      <TouchableOpacity onPress={handleNavigateToPost} activeOpacity={0.9}>
        ...
        {post.tags?.length > 0 && (
          <View style={styles.tagsContainer}>
            ...
            {post.tags.length > 3 && (
              <Text style={[styles.moreTagsText, { color: theme.textSecondary }]}>+{post.tags.length - 3} more</Text>
            )}
          </View>
        )}
        ...
        {post.isForSale && post.price != null && (
          <View style={styles.priceContainer}>
            <View style={[styles.priceTag, { backgroundColor: theme.success }]}>
              ...
              <Text style={styles.priceText}>${post.price} {post.currency || 'USD'}</Text>
            </View>
      ...
      <View style={styles.engagementContainer}>
        ...
        {post.viewsCount ? (
          <Text style={[styles.viewsText, { color: theme.textSecondary }]}>{formatNumber(post.viewsCount)} views</Text>
        ) : null}
      </View>
    </View>
  );
