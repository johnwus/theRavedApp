...
const FollowButton: React.FC<FollowButtonProps> = ({ userId, isFollowing = false, small = false, onToggle }) => {
  ...
  return (
    <TouchableOpacity
      ...
      activeOpacity={0.7}
      disabled={loading}
      style={{ backgroundColor: bg, paddingVertical: paddingV, paddingHorizontal: paddingH, borderRadius }}
    >
      {loading ? (
